...
var tokens3 = (0, import_core3.createTokens)({
...
var fonts2 = {
  ...
  body: (0, import_core4.createFont)({
  ...
  heading: (0, import_core4.createFont)({
    family: 'Inter, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif',
    size: {
      1: 16,
      2: 20,
  ...
  mono: (0, import_core4.createFont)({
...
// skylight/config.ts
var skylightConfig = (0, import_core5.createTamagui)({
